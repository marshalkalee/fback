...
// Получить все элементы портфолио (доступно всем авторизованным пользователям)
...
// Создать новый элемент (доступно для админов и редакторов)
...
// Обновить элемент (доступно только для админов)
...
// Удалить элемент (доступно только для админов)
